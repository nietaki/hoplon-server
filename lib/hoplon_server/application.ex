defmodule HoplonServer.Application do
  @moduledoc false
  ...
  defp certificate_path() do
    Application.app_dir(:hoplon_server, "priv/localhost/certificate.pem")
  end

  defp certificate_key_path() do
    Application.app_dir(:hoplon_server, "priv/localhost/certificate_key.pem")
  end
end
